    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 py-5" style={{ borderBottom: '1px solid #252931' }}>
        ...
        <div>
          ...
          <p className="text-xs leading-none mt-0.5" style={{ color: '#5f6875' }}>Assessoria Industrial</p>
        </div>
      </div>
      ...
      <nav className="flex-1 py-2">
        ...
        <div>
          ...
          <div className="flex items-center gap-2.5 mx-2 px-3 py-2 rounded-lg text-sm cursor-pointer"
            style={{ color: '#5f6875' }}>
